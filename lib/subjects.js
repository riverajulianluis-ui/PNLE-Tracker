...
export const STATUS_META = {
  not_started: { label: 'Not Started', icon: '○', bg: 'var(--status-not-started-bg)', text: 'var(--status-not-started-text)' },
  in_progress: { label: 'In Progress', icon: '◐', bg: 'var(--status-in-progress-bg)', text: 'var(--status-in-progress-text)' },
  mastered: { label: 'Mastered', icon: '✓', bg: 'var(--status-mastered-bg)', text: 'var(--status-mastered-text)' },
  relearning: { label: 'Relearning', icon: '↻', bg: 'var(--status-relearning-bg)', text: 'var(--status-relearning-text)' },
};
